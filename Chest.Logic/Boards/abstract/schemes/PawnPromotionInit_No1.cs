...
{
	public class PawnPromotionInit_No1 : IBoardInitScheme
	{
		public void Init(Board board)
		{
			...
			Piece pawnW = board[6, 0];
			board[6, 0] = null;

			board[1, 1] = null;// remove pawn black
			Piece knightB = board[0, 1];
			board[0, 1] = null;
			board[2, 4] = knightB;

			//add the pawn to the correct position to promote
			board[1, 1] = pawnW;
